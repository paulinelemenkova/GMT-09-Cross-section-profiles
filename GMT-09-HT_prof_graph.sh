...
gmt psscale -Dg170.2/-44.5+w20.0c/0.4c+v+o0.3/0i+ml \
...
gmt psbasemap -R -J \
    ...
    --FONT=9p,Palatino-Roman,black -O -K >> $ps
# SEGMENT
...
echo "110 -4000 Pacific Plate" | gmt pstext -R -J -Gwhite -F+jBL+f10p,brown -O -K >> $ps
...
2.0 11.0 GEBCO DEM Global Relief Model 15 arc sec resolution grid
EOF
