...
gmt grdcontour kkt_relief.nc -R -J \
    -C1000 -W0.5p \
    -B+t"Cross-sectional profiles of the Kuril-Kamchatka Trench: southern part" \
     -O -K >> $ps
# Step-9. Add grid
gmt psbasemap -R -J \
    ...
    -UBL/-15p/-35p -O -K >> $ps
# annotation
echo "141.0 41.0 B" | gmt pstext -R -J -F+jBL+f20p,black -Gfloralwhite -W0.5p -O -K >> $ps
...
gmt grdtrack trench1.txt -Gkkt_relief.nc -C400k/2k/20k -Sa+sstack1.txt > table1.txt
...
# Step-14. Plot graph
gmt psxy -R-200/200/-10000/2000 -JX6i/2i -Y7.5i \
...
echo "-50 -1000 Mean stacked profile with error bars" | gmt pstext -R -J \
...
gmt psconvert cross1KKT.ps -A0.7c -E720 -Tj -P -Z
