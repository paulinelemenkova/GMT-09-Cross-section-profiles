...
#grdcut ETOPO1_Ice_g_gmt4.grd -R320/340/-63/-53 -Gsst_relief.nc
grdcut GEBCO_2019.nc -R320/340/-63/-53 -Gsst_relief.nc
...
gmt psxy -R -J -W0.5p,blue tableSST.txt -O -K >> $ps
...
gmt logo -Dx6.4/-18.7+0.25c/1.5c+w2c -O >> $ps
